...
import com.example.app.factory.OfferServiceFactory;

public class CheckoutSystemWithOfferIntegrationTest {

    private CheckoutSystemWithOffer checkoutSystem;

    @Before
    public void setUp() throws Exception {
        checkoutSystem = new CheckoutSystemWithOffer(new OfferServiceFactory());
    }
